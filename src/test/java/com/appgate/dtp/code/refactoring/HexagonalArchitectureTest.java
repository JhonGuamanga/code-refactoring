package com.appgate.dtp.code.refactoring;
...
class HexagonalArchitectureTest {
    ...
    static final String OUTPUT_ADAPTERS = "output adapters";
    static final JavaClasses classes = new ClassFileImporter().importPackages("com.appgate.dtp.code.refactoring");
    ...
    static Architectures.LayeredArchitecture getLayeredArchitecture() {
        ...
        return layeredArchitecture()
            ...
            .layer(DOMAIN).definedBy("com.appgate.dtp.code.refactoring.domain..*")
            .layer(APPLICATION).definedBy("com.appgate.dtp.code.refactoring.application..*")
            .layer(INPUT_ADAPTERS).definedBy("com.appgate.dtp.code.refactoring.adapters.in..*")
            .layer(OUTPUT_ADAPTERS).definedBy("com.appgate.dtp.code.refactoring.adapters.out..*");
    }
}
